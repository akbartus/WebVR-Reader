! function (e) {
    ...
    a.m = e, a.c = t, a.d = function (e, t, d) {
        ...
        if (a.r(d), Object.defineProperty(d, "default", {
            ...
            for (var n in e) a.d(d, n, function (t) {
                return e[t]
            }.bind(null, n));
        return d
    }, a.n = function (e) {
    ...
    e.exports = function (e, t) {
        ...
        let r = e.key,
            s = e.keyCode;
        if ("vr" === t) s = parseInt(document.querySelector(`#${e.target.id}`).getAttribute("key-code")), r = document.querySelector(`#${e.target.id}`).getAttribute("value");
    ...
    AFRAME.registerComponent("keyboard-button", {
        init: function () {
            ...
            e.addEventListener("mousedown", (function () {
                ...
                e.setAttribute("material", "opacity", this.isMouseEnter ? "0.9" : "0")
    ...
    e.exports = class {
        ...
        drawKeyboard() {
            ...
            if (this.keyboardKeys) {
                const e = this.keyboardKeys[this.activeMode] || this.keyboardKeys.normal,
                    ...
                    a = .52,
                    d = .04 * e.length + .004 * (e.length - 1) + .04;
                ...
                for (let t = 0; t < e.length; t++) {
                    ...
                    for (let e = 0; e < a.length; e++) {
                        ...
                        if (!this.dismissable && "cancel" === t.type) continue;
        ...
        parseKeyObjects(e) {
            ...
            switch (t) {
                case "delete":
                    return {
                        size: "0.04 0.04 0", value: a, code: "8"
                    };
                case "enter":
                    return {
                        size: "0.04 0.084 0", value: a, code: "13"
                    };
                case "shift":
                    return {
                        size: "0.084 0.04 0", value: a, code: "16"
                    };
                case "alt":
                    return {
                        size: "0.084 0.04 0", value: a, code: "18"
                    };
                case "space":
                    return {
                        size: `${.2+.016} 0.04 0`, value: a, code: "32"
                    };
                case "cancel":
                    return {
                        size: "0.084 0.04 0", value: a, code: "24"
                    };
                case "submit":
                    return {
                        size: "0.084 0.04 0", value: a, code: "06"
                    };
                default:
                    return {
                        size: "0.04 0.04 0", value: a, code: a.charCodeAt(0)
                    }
            }
        }
    }
